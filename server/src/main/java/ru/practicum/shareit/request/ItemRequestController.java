...
public class ItemRequestController {
    ...
    @GetMapping
    public Collection<ItemRequestDto> getByUser(@RequestHeader("X-Sharer-User-Id") Long requesterId) {
        log.info("получение списка запросов по пользователю под id: " + requesterId);
        return itemRequestService.getByUser(requesterId);
    }

    @GetMapping("all")
    public Collection<ItemRequestDto> getAll(@RequestHeader("X-Sharer-User-Id") Long requesterId,
